            ...
            {isFlashLoading && device === "flash" ? (
                ...
                <>
                    {!installed_image?.info?.error_occurred ? (
                        ...
                        <p>
                            <strong>Error:</strong>{" "}
                            {installed_image?.info?.error_message}
                        </p>
                    )}
                    <p>
                    ...
                    <div>
                        ...
                        {device === "emmc" ? (
                            <>
                                <BackUpImageModal endpoint={endpoint} />
                                <RestoreImageModal endpoint={endpoint} />
                            </>
                        ) : (
                            <></>
                        )}
